...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2636.588354326979; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2548.0276672302853; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1564.9085601677773; // x position of the perpendicular encoder (in tick units)
    }
